...
:Yes
7za a -t7z -m0=lzma2 -mmt=2 -mx=9 -mfb=273 -md=96m -p065195 -mhe=on -ms=512m -bt "D:\Apps\Windows-Backup\Plugins-%timestamp%.7z" "D:\Apps\Windows-Backup\CloneApp\Plug-ins"
color 2f
pause
goto exit
